...
Well, we're going to find out! The Nobel Foundation has made a dataset available of all prize winners from the start of the prize, in 1901, to 2016. Let's load it in and
...
For most scientists/writers/activists a Nobel Prize would be the crowning achievement of a long career. But for some people, one is just not enough, and few have gotten it more than once.


```python
# Selecting the winners that have received 2 or more prizes.
...
### How old are the winner when they get the prize?
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x173a4a2efc8>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x173a4a0b108>
